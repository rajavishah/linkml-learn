# Contributing to linkml-learning

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
linkml-learning. These guidelines are not strict rules.
...
The linkml-learning team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the linkml-learning technical leads
...
[issues]: https://github.com/my-org/linkml-learning/issues/
[pulls]: https://github.com/my-org/linkml-learning/pulls/
